...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { database_id: @requirement.database_id, description: @requirement.description, name: @requirement.name, priority: @requirement.priority, type: @requirement.type } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { database_id: @requirement.database_id, description: @requirement.description, name: @requirement.name, priority: @requirement.priority, type: @requirement.type } }
