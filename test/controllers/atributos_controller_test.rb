...
class AtributosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atributo" do
    assert_difference('Atributo.count') do
      post atributos_url, params: { atributo: { name: @atributo.name, requirement_id: @atributo.requirement_id } }
    end
  ...
  test "should update atributo" do
    patch atributo_url(@atributo), params: { atributo: { name: @atributo.name, requirement_id: @atributo.requirement_id } }
